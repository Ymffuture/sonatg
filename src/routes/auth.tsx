    ...
    try {
      if (mode === "signup") {
        ...
        if (isReservedSonaName(name)) {
          toast.info("\"Sona\" is a reserved name", {
      ...
      setErrorMsg(msg);
      toast.warning(mode === "signup" ? "Couldn't create account" : "Couldn't sign in", {
        description: msg,
      });
    } finally {
      setLoading(false);
            ...
            <div className="flex flex-col justify-center p-6 sm:p-10 lg:w-1/2 lg:py-12 lg:px-16 xl:px-20">
              ...
              {errorMsg && (
                ...
                >
                  <Alert 
                    status="danger" 
                    className="rounded-xl border border-red-500/20 bg-red-500/5 dark:bg-red-500/10 dark:border-red-500/20 backdrop-blur-sm"
                  >
                    <Alert.Content>
                      <Alert.Description className="text-sm font-medium text-red-600 dark:text-red-400">
                        {errorMsg}
                      </Alert.Description>
                    </Alert.Content>
                    <CloseButton 
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                >
                  ...
                  <span className="flex-1 text-left">{oauthLoading === "google" ? `${strings} Google…` : `${strg} Google`} </span>
                ...
                {showMoreMethods && (
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="flex-1 text-left">{oauthLoading === "github" ? `${strings} GitHub…` : `${strg} GitHub`}</span>
